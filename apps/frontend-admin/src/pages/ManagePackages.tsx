                        ...
                        {[1, 2, 3, 4, 5].map((i) => (
                            <tr key={i} className="border-b border-white/5 hover:bg-white/5 transition-colors">
                                ...
                                <td className="py-4 px-4 flex justify-end gap-2">
                                    <button className="p-2 hover:bg-white/10 rounded-lg text-white/60 hover:text-white"><Eye size={16} /></button>
                                    <button className="p-2 hover:bg-white/10 rounded-lg text-white/60 hover:text-white"><Edit size={16} /></button>
