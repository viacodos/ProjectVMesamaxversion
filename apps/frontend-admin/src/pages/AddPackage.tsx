...
export const AddPackage = () => {
    return (
        <div className="space-y-6 text-white">
            ...
            <p className="text-white/70">Upload your travel package details via Excel (.xlsx) file.</p>

            <div className="border-2 border-dashed border-white/20 rounded-2xl p-12 flex flex-col items-center justify-center text-center hover:border-ochre/50 hover:bg-white/5 transition-all cursor-pointer">
                ...
                <h3 className="text-xl font-medium mb-2">Drag & Drop Excel File</h3>
                <p className="text-white/40 text-sm">or click to browse</p>
            </div>

            <div className="bg-glass-light p-6 rounded-xl border border-white/10 mt-8">
                <h3 className="text-lg font-medium mb-4">Template Guidelines</h3>
