        ...
        <div className="min-h-screen pt-24 px-6 bg-neutral-900 text-white">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mt-12">
                <div className="bg-glass-light p-8 rounded-2xl border border-white/10">
                    ...
                    <p className="text-white/70">Travel in comfort with our fleet of luxury vehicles and experienced drivers.</p>
                </div>
                <div className="bg-glass-light p-8 rounded-2xl border border-white/10">
                    <h2 className="text-3xl font-serif mb-4">Domestic Flights</h2>
                    <p className="text-white/70">Save time and enjoy aerial views with Cinnamon Air connections.</p>
                </div>
            </div>
        </div>
    );
