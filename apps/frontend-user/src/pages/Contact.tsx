...
export const Contact = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        setFormData({ inquiryType: 'General Inquiry', name: '', email: '', phone: '', subject: '', message: '' });
    ...
    return (
        <div className="min-h-screen bg-background">
            ...
            <div className="relative h-[40vh] md:h-[50vh] w-full overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-r from-teal-900/90 to-emerald-900/70 z-10"></div>
                <img
                    src="https://images.unsplash.com/photo-1559827260-dc66d52bef19?auto=format&fit=crop&w=1920"
                    alt="Contact us"
                    className="absolute inset-0 w-full h-full object-cover"
                />
                <div className="relative z-20 h-full flex flex-col items-center justify-center text-center px-6">
                    <h1 className="text-5xl md:text-7xl font-serif text-white mb-4">Contact Us</h1>
                    <p className="text-xl text-gray-200 max-w-2xl">
                        We're here to help you plan your perfect Sri Lankan adventure. Get in touch with our travel experts!
                    </p>
                </div>
            </div>
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <div>
                                    ...
                                    <select
                                        ...
                                        required
                                        className="mt-1 w-full bg-background border border-input rounded-lg px-4 py-2.5 text-foreground focus:outline-none focus:ring-2 focus:ring-ochre"
                                    >
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="bg-gradient-to-br from-ochre/10 to-ochre/5 border border-ochre/20 rounded-2xl p-6">
                                ...
                                <p className="text-sm text-muted-foreground mb-3">
                                    We typically reply within <strong className="text-ochre">24 hours</strong> during business days.
                                </p>
